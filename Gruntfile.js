...
module.exports = function (grunt)
{
    ...
    grunt.initConfig({
        ...
        browserSync: {
            dev: {
                src: ['./', appConfig.app + '/**/*.*', appConfig.example]
            },
            options: {
                server: {
                    baseDir: [appConfig.app, appConfig.example],
                    routes: {
...
// Test settings
            ...
            unitSingleRunDist: {
                ...
                options: {
                    files: [
                        ...
                        // endbower
                        '<%= appConfig.dist %>/angular-input-wheel.min.js',
        ...
        copy: {
            ...
            unminifiedJs: {
                files: [
                    ...
                    {
                        flatten: true,
                        src: ['.tmp/concat/angular-input-wheel.min.js'],
                        dest: '<%= appConfig.dist %>/angular-input-wheel.js'
                    }
                ]
            },
            ghPages: {
        ...
        bump: {
            options: {
                ...
                commitFiles: [
                    'package.json',
                    'bower.json',
                    'dist/angular-input-wheel.min.js',
                    'dist/angular-input-wheel.js'
                ],
                createTag: true,
                tagName: 'v%VERSION%',
                tagMessage: 'Version %VERSION%',
                push: true,
                pushTo: 'git@github.com:johannesjo/angular-input-wheel.git',
    ...
    grunt.registerTask('serve', 'Compile then start a connect web server', function (target)
    {
        ...
        if (target === 'sync') {
            serverTask = 'browserSync:dev';
        } else {
            serverTask = 'connect:livereload';
        }
